    ...
    <div className="mt-4 space-y-4">
      ...
      <div className="rounded-lg overflow-hidden border-2 border-green-500/40">
        ...
        <div className="bg-gray-900 p-4 font-mono text-sm space-y-1">
          ...
          <div className="pt-2"><span className="text-gray-500">outcome.result:</span>  <span className="text-green-400 font-bold">SUCCESS</span></div>
          <div className="pt-2"><span className="text-gray-500">actor.displayName:</span>   <span className="text-blue-400 font-semibold">ProGear Sales Agent</span></div>
          <div><span className="text-gray-500">actor.id:</span>            <span className="text-blue-300">wlp8x5q7mvH86KvFJ0g7</span></div>
          <div className="pt-2"><span className="text-gray-500">target.displayName:</span>  <span className="text-purple-400 font-semibold">Sarah Sales</span></div>
          ...
          <div><span className="text-gray-500">grantedScopes:</span>       <span className="text-green-400 font-semibold">inventory:read</span></div>
        </div>
      </div>
      ...
      <div className="rounded-lg overflow-hidden border-2 border-red-500/40">
        ...
        <div className="bg-gray-900 p-4 font-mono text-sm space-y-1">
          ...
          <div className="pt-2"><span className="text-gray-500">outcome.result:</span>  <span className="text-red-400 font-bold">FAILURE</span></div>
          <div><span className="text-gray-500">outcome.reason:</span>  <span className="text-red-400 font-bold">no_matching_policy</span></div>
          <div className="pt-2"><span className="text-gray-500">actor.displayName:</span>   <span className="text-blue-400 font-semibold">ProGear Sales Agent</span></div>
          <div><span className="text-gray-500">actor.id:</span>            <span className="text-blue-300">wlp8x5q7mvH86KvFJ0g7</span></div>
          <div className="pt-2"><span className="text-gray-500">target.subject:</span>      <span className="text-purple-300">00u8xdeptoh4cK9pG0g7</span> <span className="text-gray-600">(Sarah Sales)</span></div>
          <div className="pt-2"><span className="text-gray-500">authorizationServer:</span> <span className="text-cyan-300">ProGear Inventory MCP</span></div>
          <div><span className="text-gray-500">requestedScopes:</span>     <span className="text-red-400 line-through">inventory:write</span></div>
