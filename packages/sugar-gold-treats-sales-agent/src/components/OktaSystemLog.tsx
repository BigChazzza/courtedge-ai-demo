    ...
    <div className="mt-4 space-y-4">
      ...
      <div className="rounded-lg overflow-hidden border-2 border-green-500/40">
        ...
        <div className="bg-gray-900 p-4 font-mono text-sm space-y-1">
          ...
          <div className="pt-2"><span className="text-gray-500">actor.displayName:</span>   <span className="text-blue-400 font-semibold">Sugar & Gold Treats Sales Agent</span> <span className="text-gray-400 text-sm italic ml-4">← AI Agent</span></div>
          ...
          <div><span className="text-gray-500">target.alternateId:</span>  <span className="text-purple-300">sarah.sales@sugar-gold-treats.demo</span></div>
          <div className="pt-2"><span className="text-gray-500">authorizationServer:</span> <span className="text-cyan-300">Sugar & Gold Treats Inventory MCP</span> <span className="text-gray-400 text-sm italic ml-4">← Resource being accessed</span></div>
      ...
      <div className="rounded-lg overflow-hidden border-2 border-red-500/40">
        ...
        <div className="bg-gray-900 p-4 font-mono text-sm space-y-1">
          ...
          <div className="pt-2"><span className="text-gray-500">actor.displayName:</span>   <span className="text-blue-400 font-semibold">Sugar & Gold Treats Sales Agent</span> <span className="text-gray-400 text-sm italic ml-4">← Same AI Agent</span></div>
          <div><span className="text-gray-500">actor.id:</span>            <span className="text-blue-300">wlp8x5q7mvH86KvFJ0g7</span></div>
          ...
          <div className="pt-2"><span className="text-gray-500">authorizationServer:</span> <span className="text-cyan-300">Sugar & Gold Treats Inventory MCP</span></div>
